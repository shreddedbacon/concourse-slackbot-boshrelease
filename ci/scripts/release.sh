...
- name: concourse-slackbot
  version: $VERSION
  sha1: $SHA1
  url: https://github.com/shreddedbacon/concourse-slackbot-boshrelease/releases/download/v$VERSION/concourse-slackbot-boshrelease-$VERSION.tgz
\`\`\`
EOF
...
- name: concourse-slackbot
  version: $VERSION
  sha1: $SHA1
  url: https://github.com/shreddedbacon/concourse-slackbot-boshrelease/releases/download/v$VERSION/concourse-slackbot-boshrelease-$VERSION.tgz" >> manifests/deployment.yml.tmp
